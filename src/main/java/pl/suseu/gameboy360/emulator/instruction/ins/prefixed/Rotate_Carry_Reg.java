...
public class Rotate_Carry_Reg extends Opcode {

    public Rotate_Carry_Reg(RegisterUtils.Register register) {
        super("RdC reg",
                (gb, ins) -> {
                    ...
                    if (reg != RegisterUtils.Register.HL_ADDR) {
                        if (dir == 0)
                            PrefixedUtils.rotateLeftCarry(gb, reg);
                        else
                            PrefixedUtils.rotateRightCarry(gb, reg);
